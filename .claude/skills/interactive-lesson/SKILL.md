...
description: Convert a Markdown note into an interactive web page (HTML/CSS/JS): step-by-step lesson, comprehension questions with immediate feedback, progress bar, and clean design. Use when the user asks to convert content to web, create an interactive lesson, generate an HTML page from a .md file, or publish didactic material on Vercel or GitHub Pages.
---

# Skill: Interactive Lesson

Transform any `.md` file into a self-contained web page (single HTML file) that students can use in a browser without installing anything.
